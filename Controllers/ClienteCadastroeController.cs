...
{
    public class ClienteCadastroeController : Controller
    {
        private readonly Context _context;

        public ClienteCadastroeController(Context context)
        {
            _context = context;
        }

        // GET: ClienteCadastroe
        public async Task<IActionResult> Index()
        {
            return View(await _context.Clientecadastro.ToListAsync());
        }

        // GET: ClienteCadastroe/Details/5
        ...
        // GET: ClienteCadastroe/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ClienteCadastroe/Create
        ...
        // POST: ClienteCadastroe/Delete/5
